            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                ...
                <div className={`grid grid-cols-1 md:grid-cols-3 gap-8`}>
                    {newsItems.map((item, index) => (
                        <div
                            key={index}
                            className="relative group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl border border-white/20 rounded-3xl 
                ...
                <div className="mt-16 text-center animate-fade-in-up delay-400">
                    <div className="bg-gradient-to-r from-indigo-500/15 to-cyan-500/15  backdrop-blur-xl border border-white/20 rounded-3xl p-8">
