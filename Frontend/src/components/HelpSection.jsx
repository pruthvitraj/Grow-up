        ...
        >
            ...
            <div className="relative z-10 max-w-5xl mx-auto text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                    <div className={`relative group rounded-xl p-8 transform hover:-translate-y-2 transition-all duration-300 animate-fade-in-up delay-300 ${cardClasses}`}>
                    ...
                    <div className={`relative group rounded-xl p-8 transform hover:-translate-y-2 transition-all duration-300 animate-fade-in-up delay-400 ${cardClasses}`}>
                        <div className="text-5xl mb-4">📞</div>
                    ...
                    <div className={`relative group rounded-xl p-8 transform hover:-translate-y-2 transition-all duration-300 animate-fade-in-up delay-500 ${cardClasses}`}>
                        <div className="text-5xl mb-4">💬</div>
                ...
                <div className="gap-7">
                    <div className="animate-fade-in-up delay-600 mb-10">
                        <div className="bg-gradient-to-r from-orange-500/15 to-yellow-500/15 backdrop-blur-xl border border-white/20 rounded-xl p-8">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {faqs.map((faq, idx) => (
                            <div
                                key={idx}
                                className={`rounded-xl p-6 transition-all duration-300 hover:-translate-y-1 ${theme === 'light'
