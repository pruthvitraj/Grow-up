      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-14 items-center">
        ...
        <div className="flex justify-center md:justify-end animate-fade-in-up">
          <div className="relative w-full max-w-lg">
            {/* Neon Glow */}
            <div className={`absolute -inset-3 bg-gradient-to-r ${neonFrameGlow} blur-2xl rounded-3xl`} />

            <video
              className="relative w-full rounded-3xl shadow-2xl border border-white/20 backdrop-blur-xl"
              src={sideMp4}
              autoPlay
              loop
              muted
