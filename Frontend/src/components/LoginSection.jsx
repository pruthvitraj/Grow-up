...
const LoginSection = () => {
    ...
    const sectionClasses = theme === 'light'
        ? ' from-white via-emerald-50 to-emerald-100 text-gray-900'
        : 'bg-[#051d3e] text-white';

    const bubble1 = theme === 'light' ? ' ' : 'bg-green-500/10';
    const bubble2 = theme === 'light' ? 'bg-emerald-300/30' : 'bg-emerald-500/10';
        ...
        <section id="login" className={`relative py-20 md:py-32 px-6 overflow-hidden transition-colors duration-300 ${sectionClasses}`}>
            ...
            <div className="relative z-10 max-w-5xl mx-auto text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
                    <div className={`relative group rounded-3xl p-8 animate-fade-in-up delay-300 transform hover:-translate-y-2 transition-all duration-300 ${cardClasses}`}>
                    ...
                    <div className={`relative group rounded-3xl p-8 animate-fade-in-up delay-400 transform hover:-translate-y-2 transition-all duration-300 ${cardClasses}`}>
                        <div className="text-5xl mb-4">💼</div>
