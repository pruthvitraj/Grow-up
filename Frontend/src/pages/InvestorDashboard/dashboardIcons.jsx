...
export const menu = [
    { name: "Update Profile", icon: icons.profile, to: "profile" },
    { name: "Communication", icon: icons.chat, to: "communication" },
    { name: "Deals", icon: icons.deal, to: "deals" },
    { name: "Connections", icon: icons.connection, to: "connections" },
    { name: "Founders", icon: icons.founder, to: "founders" },
    { name: "Watchlist", icon: icons.watchlist, to: "watchlist" },
    { name: "Funding / Bonds", icon: icons.funding, to: "funding" },
    { name: "Appointments", icon: icons.appointment, to: "appointments" },
    { name: "Sector Growth", icon: icons.sector, to: "sector" },
];
